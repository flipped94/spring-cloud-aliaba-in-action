package com.flipped.learn.gateway.constant;
...
public class GatewayConstant {
    ...
    public static final String AUTHORITY_CENTER_TOKEN_URL_FORMAT =
            "http://authority-center/ecommerce-authority-center/authority/token";

    /**
     * 去授权中心注册并拿到 token 的 uri 格式化接口
     */
    public static final String AUTHORITY_CENTER_REGISTER_URL_FORMAT =
            "http://authority-center/ecommerce-authority-center/authority/register";
}
